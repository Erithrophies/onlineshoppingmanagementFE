...
export default function ProductListClient({ products }: { products: Product[] }) {
  ...
  return (
    <div className="min-h-screen !bg-gradient-to-r !from-zinc-700 via-zinc-500 !to-zinc-700 py-16 px-6 font-sans">
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow text-gray-100">
                ...
                <button
                  ...
                  className="mt-6 w-full flex items-center justify-center px-5 py-3 rounded-full bg-gray-200  text-black hover:opacity-90 transition font-medium tracking-wide"
                >
                  Buy
                </button>
              </div>
