...
//       <header className="header-bg fixed top-0 left-0 w-full z-50">
...
//             <a href="/store" className="link-hover cursor-pointer text-gray-300 hover:text-white">Store</a>
//             <a href="/mac" className="link-hover cursor-pointer text-gray-300 hover:text-white">Mac</a>
//             <a href="/ipad" className="link-hover cursor-pointer text-gray-300 hover:text-white">iPad</a>
//             <a href="/iphone" className="link-hover cursor-pointer text-gray-300 hover:text-white">iPhone</a>
//             <a href="/watch" className="link-hover cursor-pointer text-gray-300 hover:text-white">Watch</a>
//             <a href="/support" className="link-hover cursor-pointer text-gray-300 hover:text-white">Support</a>
//           </nav>

//           {/* Right-aligned icons */}
//           <div className="flex-grow flex justify-end items-center space-x-6 text-sm">
//             {/* Search icon */}
//             <a href="/search" className="link-hover cursor-pointer text-gray-300 hover:text-white">
...
//             {/* Shopping bag icon */}
//             <a href="/shop" className="link-hover cursor-pointer text-gray-300 hover:text-white">
//               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
